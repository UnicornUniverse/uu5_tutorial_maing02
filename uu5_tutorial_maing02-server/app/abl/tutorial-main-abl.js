...
const Errors = require("../api/errors/tutorial-main-error.js");
...
const logger = LoggerFactory.get("TutorialMainAbl");

class TutorialMainAbl {
  constructor() {
...
module.exports = new TutorialMainAbl();
